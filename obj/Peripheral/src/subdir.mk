...
Peripheral/src/%.o: ../Peripheral/src/%.c
	@	riscv-none-embed-gcc -march=rv32ecxw -mabi=ilp32e -msmall-data-limit=0 -msave-restore -fmax-errors=20 -Os -fmessage-length=0 -fsigned-char -ffunction-sections -fdata-sections -fno-common -Wunused -Wuninitialized -g -I"f:/CHW/EVT/EXAM/I2C/I2C_DRV2605 - 副本/Debug" -I"f:/CHW/EVT/EXAM/I2C/I2C_DRV2605 - 副本/Core" -I"f:/CHW/EVT/EXAM/I2C/I2C_DRV2605 - 副本/User" -I"f:/CHW/EVT/EXAM/I2C/I2C_DRV2605 - 副本/Peripheral/inc" -std=gnu99 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -c -o "$@" "$<"
